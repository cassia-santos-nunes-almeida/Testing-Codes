...
\draw (2,4) -- (3,4)
      to[opening switch, l={\shortstack{$t{=}0$\\(opens)}}, switch name/.append style={}] (5,4);
...
\draw (5.5,4) -- (6.5,4)
      to[closing switch, l={\shortstack{$t{=}0$\\(closes)}}] (8.5,4);
...
\draw (9,4) -- (10,4)
      to[closing switch, l={\shortstack{$t{=}0$\\(closes)}}] (12,4);
...
\draw (12.5,4) -- (13.5,4)
      to[opening switch, l={\shortstack{$t{=}0$\\(opens)}}] (15.5,4);
